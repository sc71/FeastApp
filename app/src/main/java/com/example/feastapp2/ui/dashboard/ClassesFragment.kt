...
class ClassesFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        cardModelArrayList.add(CardModel("Course One", "Week 9 of 16", R.drawable.food_icon))
        cardModelArrayList.add(CardModel("Course Two", "Week 2 of 8", R.drawable.nutrition_label))
        cardModelArrayList.add(CardModel("Course Three", "Week 2 of 8", R.drawable.grocery_cart))
        val cardModelArrayList2: ArrayList<CardModel> = ArrayList<CardModel>()
        cardModelArrayList2.add(CardModel("Course One", "Week 9 of 16", R.drawable.grocery_cart))
        cardModelArrayList2.add(CardModel("Course Two", "Week 2 of 8", R.drawable.nutrition_label))
        cardModelArrayList2.add(CardModel("Course Three", "Week 2 of 8", R.drawable.food_icon))
